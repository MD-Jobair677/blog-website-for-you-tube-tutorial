...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('dashbord/assets/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('dashbord/assets/css/lineicons.css') }}" rel="stylesheet" type="text/css " />
    <link rel="stylesheet" href="{{ asset('dashbord/assets/css/materialdesignicons.min.css' ) }}" rel="stylesheet" type="text/css" />

    <link rel="stylesheet" href="{{ asset('dashbord/assets/css/fullcalendar.css') }}"/> 

    <link rel="stylesheet" href="{{ asset('dashbord/assets/css/fullcalendar.css' )}}"/>
    <link rel="stylesheet" href="{{ asset('dashbord/assets/css/main.css' )}}" />
  </head>
  <body>    
    <!-- ======== Preloader =========== -->
    <!-- <div id="preloader">
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              ...
              <li>
                <a href="{{route('all-category-show')}}"> All Category </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Sub_Category</span>
            </a>
            <ul id="ddmenu_6" class="collapse dropdown-nav">
              <li>
                <a href="{{route('add-sub-category')}}"> Add Sub_Category </a>
              </li>
              <li>
                <a href="{{route('all-sub-category')}}"> All Sub_Category </a>
              </li>
            </ul>
          </li>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="{{asset('dashbord/assets/images/profile/profile-image.png')}}" alt="" />
                        </div>
                        <div>
    ...
    <script src="{{ asset('dashbord/assets/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/Chart.min.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/dynamic-pie-chart.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/moment.min.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/fullcalendar.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/jvectormap.min.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/world-merc.js') }}"></script>
    <script src="{{ asset('dashbord/assets/js/polyfill.js') }}"></script>
